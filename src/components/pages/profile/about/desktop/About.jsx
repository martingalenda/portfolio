...
const About = () => {
    ...
    return(
        <>
            <section className="about gCenter desktop_section">
                <div className="aboutme__container">
                    ...
                    <div className="container__about wow animate__fadeIn" data-wow-duration="3.5s">
                        ...
                        <div className="about__cv">
                            <Link to={texts.lang === "es" ? "https://martingalenda.github.io/portfolio/cv/cvMGES.pdf" : "https://martingalenda.github.io/portfolio/cv/cvMGEN.pdf" } target="_blank" >
                    ...
                    <div className="description__info wow animate__fadeIn" data-wow-duration="3.5s">
                        ...
                        <p style={{margin: 'auto', backgroundColor: 'rgb(93 102 95 / 3%)', border: '1px solid #243345', padding: '0.5em 2em', borderRadius: '0.75em', fontStyle: 'italic'}}>{texts.about.eslogan}</p>
                    </div>
